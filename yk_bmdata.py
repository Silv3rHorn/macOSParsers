...
def interpret(toc, data, raw_data):
    ...
    if toc_record_type == 4100:  # pathComponents
        ...
        for offset in offsets:
            ...
            toc['filePath'] += '/' + path_component.data.decode('utf-8')
        # print('filePath     : {}'.format(toc['filePath']))
